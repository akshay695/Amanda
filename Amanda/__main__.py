...
buttons = [
    [
        InlineKeyboardButton(
            text="📢Updates Channel", url="https://telegra.ph/Update-and-Support-04-10"
        ),
        InlineKeyboardButton(
            text="👥 Support Group", url="https://telegra.ph/Update-and-Support-04-10"
        ),
    ],
    [
        InlineKeyboardButton(
            text="Bot Update", url="https://telegra.ph/Update-and-Support-04-10"
        ),
        InlineKeyboardButton(
            text="❔ Help", url="http://t.me/BetterFilterXBot?start=help"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add Bot to your group ➕",
            url="t.me/BetterFilterXBot@BetterFilterXBot?startgroup=true",
        ),
    ],
]

Amanda_IMG = "https://te.legra.ph/file/aaed3fc37902acc3f9400.jpg"

HELP_STRINGS = f"""
*Main Commands :* [👩](https://te.legra.ph/file/aaed3fc37902acc3f9400.jpg)
...
def Amanda_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [SLBotsofficial](https://te.legra.ph/file/aaed3fc37902acc3f9400.jpg) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Amanda's Brother](https://te.legra.ph/file/aaed3fc37902acc3f9400.jpg)."
